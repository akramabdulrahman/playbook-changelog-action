...
```yaml
- uses: akramabdulrahman/playbook-changelog-action@6a8294e10c7610176583fa6646a63723f08b0334 # v1.1.3
```
...
```bash
git rev-parse v1.1.3^{}   # note the ^{} — without it you get the tag object, not the commit
```
